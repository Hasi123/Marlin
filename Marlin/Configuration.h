...
//#define STRING_CONFIG_H_AUTHOR "David Hasko" // Original author or contributor.
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 15.48f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.2192f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0816f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
...
#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 133
  #define DEFAULT_bedKi 26
  #define DEFAULT_bedKd 451
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 250, 30, 45 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 5000, 2500, 300, 10000 }
...
#define DEFAULT_TRAVEL_ACCELERATION   2250    // X, Y, Z acceleration for travel (non printing) moves
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, 8, -5.6 }
